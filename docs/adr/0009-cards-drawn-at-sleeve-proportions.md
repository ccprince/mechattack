# Cards are drawn at sleeve proportions and scaled per Print Size

The Mech and Vehicle templates were first drawn for a 4-up Large page (3.9" × 5.1") and scaled down
...
- **A template per Print Size**, keeping Large at 3.9" × 5.1". Rejected because every field map,
  cross-out and Dp area would exist twice. It stays the route for a card of a different shape, such
  as a landscape tarot-size card with longer Hardpoint rows.
