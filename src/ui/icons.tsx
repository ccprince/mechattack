 ...
 * worth a dependency. Each is a 16 box drawn in `currentColor`, so it follows the ink in both
 * colour schemes, and is hidden from screen readers — the button or link around it carries the name.
 */
...
export function GitHubIcon() {
  return (
    <svg {...iconAttributes} fill="currentColor" stroke="none">
